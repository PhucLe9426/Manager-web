      ...
      <div className="content">
        ...
        <main>
          ...
          <section className="metrics" aria-label="Chỉ số tổng quan">
            ...
            <article><span className="metric-icon green"><Activity /></span><div><p>Uptime trung bình <MetricHelp text="Tỷ lệ thời gian các website hoạt động bình thường trong 30 ngày. Càng gần 100% càng tốt." /></p><strong>{scannedWebsites.length ? `${averageUptime.toFixed(2)}%` : "—"}</strong><small>30 ngày gần nhất</small></div></article>
          ...
          <section className="dashboard-grid">
            <article className="panel sites-panel">
              ...
              <div className="table-wrap"><table><thead><tr><th>Website / Khách hàng</th><th>Trạng thái</th><th>Mobile <MetricHelp text="Điểm PageSpeed trên điện thoại, thang 0-100. Từ 90 là tốt, 50-89 cần cải thiện, dưới 50 là kém." /></th><th>Máy tính <MetricHelp text="Điểm PageSpeed trên máy tính, thang 0-100. Từ 90 là tốt, 50-89 cần cải thiện, dưới 50 là kém." /></th><th>Uptime <MetricHelp text="Tỷ lệ thời gian website truy cập được. Càng gần 100% càng ổn định." /></th><th>Ghi chú</th></tr></thead><tbody>
